...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-beige" data-testid="admin-dashboard">
      {/* Admin Header */}
      <div className="admin-header bg-gradient-to-r from-redwood to-red-800 text-white p-6">
        <div className="container mx-auto">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="opacity-90">Manage your competitive programming club</p>
            </div>
            <div className="flex items-center space-x-4">
              <Button
                onClick={() => window.location.href = '/'}
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-redwood"
      ...
      <div className="container mx-auto p-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                ...
                <Card className="admin-card bg-gradient-to-br from-purple-500 to-purple-600 text-white">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="text-sm opacity-90">Core Team</p>
                        <p className="text-3xl font-bold" data-testid="text-total-core-members">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-3xl font-bold" data-testid="text-total-achievements">
                  ...
                  {members.slice(0, 5).map((member) => (
                    <div key={member.id} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">{member.name} joined CSquare</p>
                      </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Dialog open={isAddEventOpen} onOpenChange={setIsAddEventOpen}>
                <DialogTrigger asChild>
                  <Button className="bg-redwood hover:bg-red-800" data-testid="button-add-event">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        {eventForm.formState.errors.title && (
                          <p className="text-red-500 text-sm">{eventForm.formState.errors.title.message}</p>
                        )}
                      </div>
                      <div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {upcomingEvents.map((event) => (
                      <div key={event.id} className="border rounded-lg p-4" data-testid={`card-upcoming-event-${event.id}`}>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {pastEvents.slice(0, 5).map((event) => (
                      <div key={event.id} className="border rounded-lg p-4" data-testid={`card-past-event-${event.id}`}>
                        <h5 className="font-semibold">{event.title}</h5>
          ...
          <TabsContent value="team" className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold">Core Team Management</h2>
              <Dialog open={isAddTeamMemberOpen} onOpenChange={setIsAddTeamMemberOpen}>
                <DialogTrigger asChild>
                  <Button className="bg-redwood hover:bg-red-800" data-testid="button-add-team-member">
                    <Plus className="h-4 w-4 mr-2" />
                    Add Team Member
                  </Button>
                </DialogTrigger>
          ...
          <TabsContent value="collaborators" className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <Dialog open={isAddCollaboratorOpen} onOpenChange={setIsAddCollaboratorOpen}>
                <DialogTrigger asChild>
                  <Button className="bg-redwood hover:bg-red-800" data-testid="button-add-collaborator">
                    <Plus className="h-4 w-4 mr-2" />
                    Add Partner
                  </Button>
                </DialogTrigger>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {collaborators.map((collaborator) => (
                <Card key={collaborator.id} className="admin-card" data-testid={`card-collaborator-${collaborator.id}`}>
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-600 text-sm mb-2">{collaborator.description}</p>
                    {collaborator.partnershipType && (
                      <Badge variant="outline" className="mb-2">{collaborator.partnershipType}</Badge>
                    )}
